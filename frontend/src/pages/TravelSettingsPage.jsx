...
import { Save, Plus, X, Mail, Route } from 'lucide-react';
import PageHeader from '../components/PageHeader';
import SectionCard from '../components/SectionCard';
import Modal from '../components/Modal';
import { useAuth } from '../context/AuthContext';
import { fetchTravelNotificationSettings, updateTravelNotificationSettings, fetchTravelRoutingSettings, updateTravelRoutingSettings } from '../services/travelService';
...
export default function TravelSettingsPage() {
  ...
  const loadSettings = async () => {
    try {
      setLoading(true);
      const [notificationData, routingData] = await Promise.all([
