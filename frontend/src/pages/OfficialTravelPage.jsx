...
export default function OfficialTravelPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <SectionCard title="Select Official Travel Type">
        <div className="grid gap-4 md:grid-cols-2">
          ...
          >
            ...
            <div>
              <h3 className="font-medium text-slate-900">Official Travel Booking</h3>
              <p className="text-sm text-slate-600">Plan official travel with DSA calculation</p>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <h3 className="font-medium text-slate-900">Official Travel Reimbursement</h3>
              <p className="text-sm text-slate-600">Submit expenses for reimbursement</p>
            </div>
          </button>
        </div>
